...
I then plotted the map with `r fontFmt("leaflet")` package, using the `Esri.NatGeoWorldMap` tiles as a basemap, along with optional scale bar and distance/area measurement tool (the map is interactive, please play with it and hover over the markers).
